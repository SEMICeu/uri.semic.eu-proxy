...
-- if the uri has trailing slash
	 ...
	 local machineprocessable = true 
		...
		derived_extension = reqext
             ...
             uri = ngx.re.sub(entity_noextension, "^/m8g/(.*)", "/semictest/releases/m8g/$1." .. derived_extension, "o")
         else
	     ...
	     if entity_extension ~= nil and urisemic.supportedext(entity_extension) then
                uri = ngx.re.sub(entity_noextension, "^/m8g/(.*)", "/semictest/releases/m8g/$1." .. entity_extension, "o")
             else 
...
--			    uri = ngx.re.sub(entity_noextension, "^/m8g/(.*)", "https://joinup.ec.europa.eu/solution/e-government-core-vocabularies", "o")
    ...
    proxy_pass  https://bertvannuffelen.github.io/;
#    https://github.com/bertvannuffelen/semictest/raw/main/releases/dist.ttl
